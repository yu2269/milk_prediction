...
mrcm_bwd_res
mrcm_bwd_variables = unlist(seed_fold_results[,"total_number_varaibles"])
...
mrcm_fs_res
mrcm_fs_variables = unlist(seed_fold_results[,"total_number_varaibles"])
...
mrcm_glmnet_res
mrcm_glmnet_variables = unlist(seed_fold_results[,"glmnet_variables"])
...
mrcm_rb_res
mrcm_rb_variables = unlist(seed_fold_results[,"rb_variables"])
...
mrcm_scad_res
mrcm_scad_variables = unlist(seed_fold_results[,"names"])
as.character(mrcm_scad_res)
df1 = data.frame(
  "bwd_variables" = as.character(mrcm_bwd_variables), 
  "bwd" = as.character(mrcm_bwd_res), 
  
  "fs_variables" = as.character(mrcm_fs_variables), 
  "fs" = as.character(mrcm_fs_res), 
  
  "glmnet_variables" = as.character(mrcm_glmnet_variables),
   "glmnet" = as.character(mrcm_glmnet_res),
  
  "rb_variables" = as.character(mrcm_rb_variables),
  "rb" = as.character(mrcm_rb_res),
  
  "scad_variables" = as.character(mrcm_scad_variables),
  "scad" = as.character(mrcm_scad_res)

           )


write.csv(t(df1), "serveral_runs.csv", col.names = F)
```